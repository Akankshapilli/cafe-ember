...
export default function MenuHeroDrinks() {
  return (
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl">
          ...
          <h1 className="max-w-4xl text-5xl font-light leading-[0.92] tracking-[-0.05em] md:text-7xl xl:text-[6.5rem]">
            Café Ember Drinks
            <span className="block text-[#C9A96E]">Artisan Coffee Rituals</span>
          </h1>

          {/* description */}
          <p className="mt-8 max-w-2xl text-sm leading-relaxed text-[#F5EFE6]/70 md:text-lg">
            Discover our complete collection of handcrafted coffees, signature
            beverages and seasonal creations.
          </p>
        </div>
      </Container>
